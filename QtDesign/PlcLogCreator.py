...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuOpen.addAction(self.actionSave_Config)
        ...
        self.actionLoad.triggered.connect(MainWindow.onOpenConfig)
        self.actionSave_Config.triggered.connect(MainWindow.onSaveConfig)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLoad.setText(QCoreApplication.translate("MainWindow", u"Load Config", None))
